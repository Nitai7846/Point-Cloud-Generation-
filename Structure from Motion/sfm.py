...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar 16 15:31:00 2023
...
#DEFINE THE CAMERA INTRINSIC PARAMS 

K = np.array([[2640.15, 0, 3000], [0, 2640.15, 2000], [0, 0, 1]])

#IF THE PROCESS IS COMPUTATIONALLY HEAVY WE CAN DOWNSCALE THE IMAGES BY A FACTOR OF 2
...
path = os.getcwd()
print(path)
#NOW WE CAN GET THE DIRECTORY WHERE THE IMAGES ARE STORED 

img_dir = '/Users/nitaishah/Desktop/MySFM/IMAGES'

#Provision for Bundle Adjustment 

bundle_adjustment = False

#Downscale the pipeline if it takes too long
...
# Function for Perspective and Point
...
#Define the Reprojection Error in the pipeline
...
def to_ply(path, point_cloud, colors, densify):
    ...
    ply_header = '''ply
		...
		'''
    if not densify:
        with open('/Users/nitaishah/Desktop/MySFM/Point Cloud/sparse2.ply', 'w') as f:
...
np.savetxt('pose2.csv', posearr, delimiter = '\n')
